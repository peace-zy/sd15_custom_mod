# version=0.26.3 add size condition
...
class StableDiffusionPipeline(
    ...
    _callback_tensor_inputs = ["latents", "prompt_embeds", "negative_prompt_embeds", "add_time_ids", "negative_add_time_ids"]
    ...
    def _get_add_time_ids(
        ...
        text_encoder_projection_dim = text_encoder_projection_dim or 0
        ...
        **kwargs,
        ...
        Args:
            ...
            negative_target_size (`Tuple[int]`, *optional*, defaults to (1024, 1024)):
                ...
                [https://huggingface.co/papers/2307.01952](https://huggingface.co/papers/2307.01952). For more
                information, refer to this issue thread: https://github.com/huggingface/diffusers/issues/4208.
            use_size_condition(`bool`, *optional*, defaults to `False`):
                Whether or not to use size condition.
            clip_skip (`int`, *optional*):
                Number of layers to be skipped from CLIP while computing the prompt embeddings. A value of 1 means that
                the output of the pre-final layer will be used for computing the prompt embeddings.
